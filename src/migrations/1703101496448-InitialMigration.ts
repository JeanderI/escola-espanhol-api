...
export class InitialMigration1703101496448 implements MigrationInterface {
    name = 'InitialMigration1703101496448'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "pronunciation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "description" character varying NOT NULL, "start" character varying, "text" character varying NOT NULL, "help" character varying, "url" character varying NOT NULL, "nextUrl" character varying, "lastUrl" character varying, "userId" uuid, CONSTRAINT "PK_03d09e54a54345f930fc5288b11" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "listening" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "description" character varying NOT NULL, "start" character varying, "end" character varying, "text" character varying NOT NULL, "help" character varying, "url" character varying NOT NULL, "nextUrl" character varying, "lastUrl" character varying, "userId" uuid, CONSTRAINT "PK_385522e31afc7cd2f023ce24ee9" PRIMARY KEY ("id"))`);
